  ...
  return (
    <span className="relative inline-flex h-5 w-5 shrink-0">
      <input
        ...
        type="checkbox"
        className={cn(
          "peer h-5 w-5 appearance-none rounded-md border border-navy-900/20 bg-white transition-colors checked:border-fern-500 checked:bg-fern-500 cursor-pointer",
          className
        )}
        {...rest}
      />
  ...
  return (
    <span className="relative inline-flex h-6 w-[42px] shrink-0">
      <input
        ...
        type="checkbox"
        className={cn(
          "peer h-6 w-[42px] appearance-none rounded-full bg-fog-300 transition-colors checked:bg-fern-500 cursor-pointer",
          className
        )}
        {...rest}
      />
